...
const ProductDetails = () => {
    const { productId, source } = useLocalSearchParams();
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Animated.View style={[styles.detailsContainer, detailsStyle]}>
                ...
                <View style={styles.variantsAndPriceContainer}>
                ...
                >
                    ...
                    <RelatedProducts productSlug={product.slug} currentSource={source as string} />
                </ScrollView>
            </Animated.View>
            <Toast />
        </SafeAreaView>
